...
//    {
//        flush_bands++;
//        returnCode = pwrite(smr_fd, ssd_buffer, BLKSZ, offset);
//        if (returnCode < 0)
//        {
//            printf("[ERROR] write_block():-------write to smr: fd=%d, errorcode=%d, offset=%lu\n", cache_fd, returnCode, offset);
//            exit(-1);
//        }
...
//    {
//        returnCode = smrwrite(smr_fd, ssd_buffer, BLKSZ, ssd_buf_tag.offset);
//        if (returnCode < 0)
//        {
...
//        returnCode = pwrite(cache_fd, ssd_buffer, BLKSZ, ssd_buf_hdr->ssd_buf_id * BLKSZ);
//        if (returnCode < 0)
//        {
//            printf("[ERROR] write():-------write to ssd: fd=%d, errorcode=%d, offset=%lu\n", cache_fd, returnCode, offset);
//            exit(-1);
//        }
//        //returnCode = fsync(cache_fd);
//        if (returnCode < 0)
//        {
//            printf("[ERROR] write_block():----------fsync\n");
//            exit(-1);
